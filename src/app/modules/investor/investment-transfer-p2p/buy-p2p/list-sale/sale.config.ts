...
export const TABLE_INVESTOR_SALE_CONFIG: ITableConfig = {
    columnDefinition: [
        ...
        new TextColumn('tranferAmount', 'Số tiền gốc(VND)', 15, null, 1),
        new TextColumn('saleAmount', 'Giá trị chuyển nhượng (VND)', 15, null, 1),
        new TextColumn('remainTranferAmount', 'Số tiền gốc còn lại (VND)', 15, null, 1),
        new TextColumn('remainSalAmount', 'Giá trị chuyển nhượng còn lại (VND)', 15, null, 1),
