...
@Component({
    selector: 'investor-invested-profile',
...
export class InvestedProfileComponent implements OnInit {
    ...
    public _tableConfig = { ...TABLE_INVESTOR_INVESTING_CONFIG, title: 'Hồ sơ đã đầu tư' , isViewDetail: false};
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    this._investorListService.invested().subscribe();
