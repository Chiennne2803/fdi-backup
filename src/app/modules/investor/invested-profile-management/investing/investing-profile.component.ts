...
@Component({
    selector: 'investor-investing-profile',
    templateUrl: './investing-profile.component.html',
    encapsulation: ViewEncapsulation.None
})
export class InvestingProfileComponent implements OnInit {
    ...
    public handleSearch($event: Event): void {
        this._investorListService.investing({
            ...this.searchPayload,
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    this._investorListService.investing().subscribe();
