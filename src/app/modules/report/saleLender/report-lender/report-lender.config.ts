...
export const TABLE_STATISTICAL_REPORT_INVESTOR_TOPUP_CONFIG: ITableConfig = {
    columnDefinition: [
        ...
        new TextColumn('expirDate', 'Ngày hoàn trả', 10, false, 'DD/MM/YYYY HH:mm:ss'),
        new TextColumn('transpayAmount', 'Số tiền hoàn trả', 10, false, 1),
        new TextColumn('debtAmount', 'Dư nợ', 10, false, 1),
        new TextColumn('manageStaffName', 'Nhân viên phụ trách', 20, false),
    ],
