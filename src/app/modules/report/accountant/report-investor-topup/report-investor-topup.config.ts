...
export const TABLE_STATISTICAL_REPORT_INVESTOR_TOPUP_CONFIG: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
        new TextColumn('transactionTime', 'Ngày nạp tiền', 25, false, 'DD/MM/YYYY HH:mm:ss'),
        new TextColumn('admAccountIdRecive', 'ID khách hàng', 25, false),
        new TextColumn('admAccountIdReciveName', 'Tên khách hàng', 25, false),
