...
export const TABLE_STATISTICAL_REPORT_TRANSFER_TRANSACTION_CONFIG: ITableConfig = {
    columnDefinition: [
        ...
        new TextColumn('tranferAmount', 'Số tiền chuyển nhượng (VND)', 10, false, 1),
        new TextColumn('saleAmount', 'Số tiền chào bán (VND)', 10, false, 1),
        new TextColumn('remainTranferAmount', 'Số tiền chuyển nhượng còn lại (VND)', 10, false, 1),
        new TextColumn('remainSalAmount', 'Số tiền chào bán còn lại (VND)', 10, false, 1),
        new TextColumn('feeP2P', 'Phí chuyển nhượng (VND)', 10, false, 1),
