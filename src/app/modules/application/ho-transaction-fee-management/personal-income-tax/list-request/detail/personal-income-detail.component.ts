...
import {PersonalIncomeTaxService} from 'app/service/admin/managementTransactionFee';
...
@Component({
    selector: 'detail-personal-income',
    templateUrl: './personal-income-detail.component.html',
    styleUrls: ['./personal-income-detail.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations: fuseAnimations,
})
export class PersonalIncomeDetailComponent implements OnInit, AfterViewInit {
    ...
    displayedColumns: string[] = ['position', 'name', 'weight', 'originOfTransaction'];
    ...
    ngOnInit(): void {
        this.debtManagement = this._personalIncomeTaxService.selectedProfile$;
        ...
        this._personalIncomeTaxService.prepare().subscribe((res) => {
            if (res) {
    ...
    submit(): void {
        ...
        dialog.afterClosed().subscribe((result) => {
            if (result) {
                ...
                this._personalIncomeTaxService.doSignReq(request).subscribe((response) => {
                    if (response.errorCode === '0') {
                        ...
                        this._personalIncomeTaxService.getDetail({fsTranferWalletReqId:this.requestId}).subscribe();
                    } else {
