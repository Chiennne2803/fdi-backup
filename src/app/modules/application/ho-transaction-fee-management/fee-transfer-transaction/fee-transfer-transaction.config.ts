...
export const TABLE_BUTTON_ACTION_CONFIG_LIST: DataTableButtonConfig = {
    commonBtn: [
        {type: 'export', role: 'SFF_REQUEST_FUNDING_EXPORT', fileName : 'Phi_chuyen_nhuong'},
    ],
    otherBtn: [
        new ButtonConfig(
            '',
...
export const TABLE_FEE_TRANSFER_TRANSACTION_REQUEST: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
...
export const TABLE_FEE_TRANSFER_TRANSACTION_LIST: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
        ...
        new TextColumn('transactionCode', 'Giao dịch chuyển nhượng', 25, false),
