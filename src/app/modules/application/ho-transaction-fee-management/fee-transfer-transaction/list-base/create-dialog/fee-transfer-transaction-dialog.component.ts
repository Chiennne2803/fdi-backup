...
@Component({
    ...
    templateUrl: './fee-transfer-transaction-dialog.component.html',
    styleUrls: ['./fee-transfer-transaction-dialog.component.scss'],
    providers: [DateTimeformatPipe]
})
export class FeeTransferTransactionDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<FeeTransferTransactionDialogComponent>,
    ...
    ngOnInit(): void {
        ...
        this._transferTransactionFeeService.initTranferWalletReq(this.request).subscribe((res) => {
    ...
    submit(): void {
        ...
        dialog.afterClosed().subscribe((res) => {
            if (res === 'confirmed' && this.requestCommissionForm.valid) {
                ...
                this._transferTransactionFeeService.create(request).subscribe((result) => {
                    if (result.errorCode === '0') {
                        this._matDialogRef.close(true);
                        this._transferTransactionFeeService.searchTransferTransactionFee().subscribe()
