...
import {TransferTransactionFeeService} from "../../../../../service/admin/managementTransactionFee";
...
import {
    ...
    TABLE_FEE_TRANSFER_TRANSACTION_REQUEST
...
@Component({
    ...
    templateUrl: './fee-transfer-transaction-request.component.html',
    encapsulation: ViewEncapsulation.None
})
export class FeeTransferTransactionRequestComponent implements OnInit {
    @ViewChild('matDrawer', {static: true}) matDrawer: MatDrawer;
    public _dataSource$: Observable<BaseResponse>;
    public _taskbarConfig = TASK_BAR_CONFIG;
    public _tableConfig = TABLE_FEE_TRANSFER_TRANSACTION_REQUEST;
                ...
                if (checkStatus) {
                    ...
                    confirmDialog.afterClosed().subscribe((res) => {
                        if ( res === 'confirmed' ) {
                            ...
                            this._transferTransactionFeeService.delete({ids: requestLock}).subscribe((res) => {
                                if (res.errorCode === '0') {
                                    this._alertService.showMessageSuccess('Xoá yêu cầu thành công');
                                    this._transferTransactionFeeService.searchTransferTransactionFeeReq(this.searchPayload).subscribe();
                                } else {
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._transferTransactionFeeService.searchTransferTransactionFeeReq({
                        ...response.form.value,
                        ...this.searchPayload,
    ...
    public handleRowClick(row: any): void {
        this._transferTransactionFeeService
            .getDetail({fsTranferWalletReqId: row.fsTranferWalletReqId})
            .subscribe((res) => {
                this._transferTransactionFeeService.openDetailDrawer();
            });
    }
    ...
    checkboxItemChange(rows): void {
        ...
        this._tableBtnConfig = {
            commonBtn: [ {type: 'export', role: 'SFF_REQUEST_FUNDING_EXPORT', fileName : 'Phi_chuyen_nhuong'},
                ...lstCommonBtn,
            ]
        };
    }
