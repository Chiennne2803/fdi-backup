...
import {LoanArrangementFeeService} from "../../../../../../service/admin/managementTransactionFee";

@Component({
    selector: 'app-request-commission-dialog',
    templateUrl: './fee-loan-arrangement-dialog.component.html',
    styleUrls: ['./fee-loan-arrangement-dialog.component.scss'],
    providers: [DateTimeformatPipe]
})
export class FeeLoanArrangementDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<FeeLoanArrangementDialogComponent>,
    ...
    ngOnInit(): void {
        ...
        this._loanArrangementFeeService.initTranferWalletReq(this.request).subscribe((res) => {
    ...
    submit(): void {
        ...
        dialog.afterClosed().subscribe((res) => {
            if (res === 'confirmed' && this.requestCommissionForm.valid) {
                ...
                this._loanArrangementFeeService.create(request).subscribe((result) => {
                    if (result.errorCode === '0') {
                        this._loanArrangementFeeService.searchLoanArrangementFee().subscribe();
