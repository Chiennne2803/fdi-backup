...
import {AccountManagementFeeService} from "../../../../../../service/admin/managementTransactionFee";
import {TextColumn} from "../../../../../../shared/models/datatable/display-column.model";

@Component({
    selector: 'app-request-commission-dialog',
    templateUrl: './fee-account-management-dialog.component.html',
    styleUrls: ['./fee-account-management-dialog.component.scss'],
    providers: [DateTimeformatPipe]
})
export class FeeAccountManagementDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<FeeAccountManagementDialogComponent>,
    ...
    ngOnInit(): void {
        ...
        this._accountManagementFeeService.initTranferWalletReq(this.request).subscribe((res) => {
    ...
    submit(): void {
        ...
        dialog.afterClosed().subscribe((res) => {
            if (res === 'confirmed' && this.requestCommissionForm.valid) {
                ...
                this._accountManagementFeeService.create(request).subscribe((result) => {
                    if (result.errorCode === '0') {
                        this._matDialogRef.close(true);
                        this._accountManagementFeeService.searchAccountManagementFee().subscribe();
