...
export const TABLE_BUTTON_ACTION_CONFIG_LIST: DataTableButtonConfig = {
    commonBtn: [
        {type: 'export', role: 'SFF_REQUEST_FUNDING_EXPORT', fileName : 'Phi_quan_ly_tai_khoan'},
    ],
    otherBtn: [
        new ButtonConfig(
            '',
...
export const TABLE_FEE_ACCOUNT_MANAGEMENT_REQUEST: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
...
export const TABLE_FEE_ACCOUNT_MANAGEMENT_LIST: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
