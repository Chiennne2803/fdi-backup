...
@Component({
    ...
    templateUrl: './overdue-interest-dialog.component.html',
    styleUrls: ['./overdue-interest-dialog.component.scss'],
    providers: [DateTimeformatPipe]
})
export class OverdueInterestDialogComponent implements OnInit {
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<OverdueInterestDialogComponent>,
    ...
    ngOnInit(): void {
        ...
        this._overdueInterestService.initTranferWalletReq(this.request).subscribe((res) => {
    ...
    submit(): void {
        ...
        dialog.afterClosed().subscribe((res) => {
            if (res === 'confirmed' && this.requestCommissionForm.valid) {
                ...
                this._overdueInterestService.create(request).subscribe((result) => {
                    if (result.errorCode === '0') {
                        this._matDialogRef.close(true);
                        this._overdueInterestService.searchOverdueInterest().subscribe();
