...
export const TABLE_BUTTON_ACTION_CONFIG_LIST: DataTableButtonConfig = {
    commonBtn: [
        {type: 'export', role: 'SFF_REQUEST_FUNDING_EXPORT', fileName : 'Phi_nap_tien'},
    ],
    otherBtn: [
        new ButtonConfig(
            'SFF_REQUEST_FUNDING_INSERT',
            true,
            false,
            'Điều chuyển tiền ví',
            'create',
...
export const TABLE_FEE_DEPOSIT_TRANSACTION_REQUEST: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
        new TextColumn('transCode', 'Mã yêu cầu', 25, true),
        new TextColumn('amount', 'Số tiền rút', 25, false, 1),
...
export const TABLE_FEE_DEPOSIT_TRANSACTION_LIST: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
        ...
        new TextColumn('transactionCode', 'Giao dịch nạp tiền', 25, false),
        new TextColumn('amount', 'Phí kết nối (VND)', 25, false, 1),
    ],
