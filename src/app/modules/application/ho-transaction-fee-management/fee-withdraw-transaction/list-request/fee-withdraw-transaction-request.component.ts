...
import {WithdrawalTransactionFeeService} from "../../../../../service/admin/managementTransactionFee";
...
import {
    ...
    TABLE_FEE_WITHDRAW_TRANSACTION_REQUEST
...
@Component({
    ...
    templateUrl: './fee-withdraw-transaction-request.component.html',
    encapsulation: ViewEncapsulation.None
})
export class FeeWithdrawTransactionRequestComponent implements OnInit {
    @ViewChild('matDrawer', {static: true}) matDrawer: MatDrawer;
    public _dataSource$: Observable<BaseResponse>;
    public _taskbarConfig = TASK_BAR_CONFIG;
    public _tableConfig = TABLE_FEE_WITHDRAW_TRANSACTION_REQUEST;
                ...
                if (checkStatus) {
                    ...
                    confirmDialog.afterClosed().subscribe((res) => {
                        if ( res === 'confirmed' ) {
                            ...
                            this._withdrawalTransactionFeeService.delete({ids: requestLock}).subscribe((res) => {
                                if (res.errorCode === '0') {
                                    this._alertService.showMessageSuccess('Xoá yêu cầu thành công');
                                    this._withdrawalTransactionFeeService.searchWithdrawalTransactionFeeReq(this.searchPayload).subscribe();
                                } else {
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._withdrawalTransactionFeeService.searchWithdrawalTransactionFeeReq({
                        ...response.form.value,
                        ...this.searchPayload,
    ...
    public handleRowClick(row: any): void {
        this._withdrawalTransactionFeeService
            .getDetail({fsTranferWalletReqId: row.fsTranferWalletReqId})
            .subscribe((res) => {
                this._withdrawalTransactionFeeService.openDetailDrawer();
            });
    }
    ...
    checkboxItemChange(rows): void {
        ...
        this._tableBtnConfig = {
            commonBtn: [ {type: 'export', role: 'SFF_REQUEST_FUNDING_EXPORT', fileName : 'Phi_rut_tien'},
                ...lstCommonBtn,
            ]
        };
    }
