...
@Component({
    ...
    templateUrl: './fee-withdraw-transaction-dialog.component.html',
    styleUrls: ['./fee-withdraw-transaction-dialog.component.scss'],
    providers: [DateTimeformatPipe]
})
export class FeeWithdrawTransactionDialogComponent implements OnInit {
    ...
    public _tableConfig = {
        columnDefinition: [
            ...
            new TextColumn('transactionCode', 'Giao dịch rút tiền', 10),
    ...
    constructor(
        ...
        private _matDialogRef: MatDialogRef<FeeWithdrawTransactionDialogComponent>,
    ...
    ngOnInit(): void {
        ...
        this._withdrawalTransactionFeeService.initTranferWalletReq(this.request).subscribe((res) => {
    ...
    submit(): void {
        ...
        dialog.afterClosed().subscribe((res) => {
            if (res === 'confirmed' && this.requestCommissionForm.valid) {
                ...
                this._withdrawalTransactionFeeService.create(request).subscribe((result) => {
                    if (result.errorCode === '0') {
                        this._matDialogRef.close(true);
                        this._withdrawalTransactionFeeService.searchWithdrawalTransactionFee().subscribe();
