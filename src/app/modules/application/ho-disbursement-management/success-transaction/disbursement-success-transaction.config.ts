...
export const TABLE_SUCCESS_TRANSACTION_CONFIG: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
        ...
        // new TextColumn('assignToName', 'Người trình ký', 15, false),
        // new TextColumn('assignDate', 'Ngày  trình ký', 15, false, 'DD/MM/YYYY HH:mm:ss'),
    ...
    title: 'Giao dịch giải ngân đã xử lý',isViewDetail: false,
    footerTable: [{
        label: 'Tổng tiền:',
        value: 0,
        type: 'VND'
...
export const TABLE_BUTTON_SUCCESS_CONFIG: DataTableButtonConfig = {
    commonBtn: [
