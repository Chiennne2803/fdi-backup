...
export const TABLE_DRAFT_TRANSACTION_CONFIG: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
    ...
    title: 'Giao dịch giải ngân',isViewDetail: false,
    footerTable: [{
        label: 'Tổng tiền:',
        value: 0,
        type: 'VND'
...
export const TASK_BAR_CONFIG: TaskBarConfig = {
    ...
    otherBtn: [
        new ButtonConfig('SFF_DISBURSEMENT_TRANSACTION_INSERT', true, false, 'Lập yêu cầu', 'feather:dollar-sign', 'add')
    ]
};

export const TABLE_BUTTON_DRAFT_CONFIG: DataTableButtonConfig = {
    commonBtn: [
        {type : 'export', role : 'SFF_DISBURSEMENT_TRANSACTION_EXPORT', fileName : 'Danh_sach_yeu_cau_giai_ngan'},
        {type : 'sign-process', role : 'SFF_DISBURSEMENT_TRANSACTION_UPDATE', label: 'Trình ký'},
        {type : 'deleted', role : 'SFF_DISBURSEMENT_TRANSACTION_DELETE', label: 'Xoá'},
    ]
};
