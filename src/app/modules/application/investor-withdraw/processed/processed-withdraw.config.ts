...
export const TABLE_INVESTOR_INVESTING_CONFIG: ITableConfig = {
    columnDefinition: [
        ...
        new TextColumn('amount', 'Số tiền (VNĐ)', 10, true, 1, false, true),
        new TextColumn('fee', 'Phí rút tiền (VNĐ)', 10, true, 1, false, true),
        new TextColumn('admAccountIdRecipientName', 'Họ và tên khách hàng', 10, false),
        new TextColumn('identification', 'Số CCCD/Hộ chiếu ', 10, false),
        new TextColumn('accName', 'Tên tài khoản thụ hưởng', 10, false),
        new TextColumn('accNo', 'Số tài khoản', 10, false),
        new TextColumn('bankName', 'Tên ngân hàng', 10, false),
        new TextColumn('branchName', 'Chi nhánh', 10, false),
        new TextColumn('info', 'Nội dung', 20, false),
        new TextColumn('createdByName', 'Người lập yêu cầu', 10, false),
        new TextColumn('approvalByName', 'Người xử lý', 10, false),
        new TextColumn('approvalDate', 'Ngày xử lý', 10, undefined, 'DD/MM/YYYY'),
        new TextColumn('approvalComment', 'Ghi chú', 10, false),
