...
export const TABLE_PROFILE_RECEPTION_CONFIG: ITableConfig = {
    columnDefinition: [
        ...
        new TextColumn('reasons', 'Mục đích', 15, false),
        new TextColumn('collateralTypeName', 'Hình thức bảo đảm', 15, false),
        new TextColumn('createdByName', 'Người lập', 20, false),
        new TextColumn('createdDate', 'Ngày lập', 15, false, 'DD/MM/YYYY HH:mm:ss'),
        new TextColumn('processStatusName', 'Trạng thái xử lý', 20, false),
