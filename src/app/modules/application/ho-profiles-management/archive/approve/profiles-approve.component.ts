...
@Component({
    selector: 'profiles-approve',
    templateUrl: './profiles-approve.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ProfilesApproveComponent implements OnInit {
    @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;

    public _tableConfig = { ...TABLE_PROFILE_MANAGEMENT_CONFIG, title: 'Hồ sơ đã phê duyệt', isViewDetail: false };
    ...
    public handleSearch($event: Event): void {
        ...
        this._profilesManagementService.doSearchLoanProfileApprove(this.searchPayload).subscribe();
    }
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._profilesManagementService.doSearchLoanProfileApprove({
                        ...response.form.value,
                        ...this.searchPayload
                    }).subscribe();
                }
