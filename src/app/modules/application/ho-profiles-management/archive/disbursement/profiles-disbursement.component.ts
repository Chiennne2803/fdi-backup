...
@Component({
    selector: 'profiles-disbursement',
    templateUrl: './profiles-disbursement.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ProfilesDisbursementComponent implements OnInit {
    @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;

    public _tableConfig = { ...TABLE_PROFILE_MANAGEMENT_CONFIG, title: 'Hồ sơ đã giải ngân', isViewDetail: false };
    ...
    public handleSearch($event: Event): void {
        ...
        this._profilesManagementService.doSearchLoanProfileDisbursement(this.searchPayload).subscribe();
    }
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._profilesManagementService.doSearchLoanProfileDisbursement({
                        ...response.form.value,
                        ...this.searchPayload
                    }).subscribe();
                }
