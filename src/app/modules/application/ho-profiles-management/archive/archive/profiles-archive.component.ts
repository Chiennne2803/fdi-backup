...
@Component({
    selector: 'profiles-archive',
    templateUrl: './profiles-archive.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ProfilesArchiveComponent implements OnInit {
    @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;

    public _tableConfig = { ...TABLE_PROFILE_MANAGEMENT_CONFIG, title: 'Hồ sơ lưu trữ' , isViewDetail: false};
    ...
    public handleSearch($event: Event): void {
        ...
        this._profilesManagementService.doSearchLoanProfileClose(this.searchPayload).subscribe();
    }
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._profilesManagementService.doSearchLoanProfileClose({
                        ...response.form.value,
                        ...this.searchPayload
                    }).subscribe();
                }
