...
@Component({
    selector: 'profiles-reject',
    templateUrl: './profiles-reject.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ProfilesRejectComponent implements OnInit {
    @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;

    public _tableConfig = { ...TABLE_PROFILE_MANAGEMENT_CONFIG, title: 'Hồ sơ bị từ chối' , isViewDetail: false};
    ...
    public handleSearch($event: Event): void {
        ...
        this._profilesManagementService.doSearchLoanProfileReject(this.searchPayload).subscribe();
    }
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._profilesManagementService.doSearchLoanProfileReject({
                        ...response.form.value,
                        ...this.searchPayload
                    }).subscribe();
                }
