...
import {
    ...
    TABLE_PROFILE_MANAGEMENT_REVIEW,
    TASK_BAR_CONFIG
...
@Component({
    ...
    templateUrl: './profiles-reviewing.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ProfilesReviewingComponent implements OnInit {
    @ViewChild('matDrawer', { static: true }) matDrawer: MatDrawer;

    public _tableConfig = TABLE_PROFILE_MANAGEMENT_REVIEW;
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._profilesManagementService.doSearchLoanProfileReview({
                        ...response.form.value,
                        ...this.searchPayload
                    }).subscribe();
                }
