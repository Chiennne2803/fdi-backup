...
import {
    TABLE_INVESTOR_INVESTING_CONFIG_SUCCESS,
    TASK_BAR_CONFIG_SUCCESS,
    TABLE_BUTTON_ACTION_SUCCESS_CONFIG
...
@Component({
    ...
    templateUrl: './success-charge-transaction.component.html',
    encapsulation: ViewEncapsulation.None
})
export class SuccessChargeTransactionComponent implements OnInit {
    ...
    public _tableConfig = { ...TABLE_INVESTOR_INVESTING_CONFIG_SUCCESS, title: 'Danh sách giao dịch thành công', isViewDetail: false };
    public _tableBtnConfig = TABLE_BUTTON_ACTION_SUCCESS_CONFIG;
    ...
    public handleSearch($event: Event): void {
        this._rechargeTransactionService.doSearchSuccessTransaction({
            ...this.searchPayload,
        ...
        dialogRef.componentInstance.btnSearchClicked.subscribe(
            (response) => {
                if (response.action === 'reset') {
                    ...
                    this._rechargeTransactionService.doSearchSuccessTransaction(response.form.value).subscribe();
                }
