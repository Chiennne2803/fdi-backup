...
export const TABLE_PROCESSED_TRANS_CONFIG: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
    ...
    title: 'Giao dịch đã phê duyệt',
    isViewDetail: false
};

export const TABLE_BUTTON_PROCESSED_TRANS_CONFIG: DataTableButtonConfig = {
