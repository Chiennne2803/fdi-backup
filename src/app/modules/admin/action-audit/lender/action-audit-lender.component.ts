...
import {
    TABLE_ACTION_AUDIT_CONFIG, TABLE_BUTTON_ACTION_CONFIG,
    TASK_BAR_CONFIG
...
@Component({
    selector: 'action-audit-lender',
    templateUrl: './action-audit-lender.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ActionAuditLenderComponent implements OnInit {
    ...
    public _tableConfig = { ...TABLE_ACTION_AUDIT_CONFIG, title: 'Giám sát truy cập nhân NVV', isViewDetail: false };
