...
import {
    TABLE_ACTION_AUDIT_CONFIG, TABLE_BUTTON_ACTION_CONFIG, TASK_BAR_CONFIG,
...
@Component({
    selector: 'action-audit-investor',
    templateUrl: './action-audit-investor.component.html',
    encapsulation: ViewEncapsulation.None
})
export class ActionAuditInvestorComponent implements OnInit {
    ...
    public _tableConfig = { ...TABLE_ACTION_AUDIT_CONFIG, title: 'Giám sát truy cập NDT', isViewDetail: false };
