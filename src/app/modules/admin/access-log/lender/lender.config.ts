...
export const TABLE_INVESTOR_TRANSPAY_REQ_PROCESS_CONFIG: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
    ...
    title: 'Giám sát truy cập nhân NVV'
};

export const TASK_BAR_TRANSPAY_REQ_PROCESS_CONFIG: TaskBarConfig = {
