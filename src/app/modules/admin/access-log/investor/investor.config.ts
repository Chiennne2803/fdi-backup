...
export const TABLE_INVESTOR_TRANSPAY_REQ_WAIT_CONFIG: ITableConfig = {
    columnDefinition: [
        new CheckboxColumn(),
    ...
    title: 'Giám sát truy cập NDT'
};

export const TASK_BAR_TRANSPAY_REQ_WAIT_CONFIG: TaskBarConfig = {
