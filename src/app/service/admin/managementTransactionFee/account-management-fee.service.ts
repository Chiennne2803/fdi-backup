...
export class AccountManagementFeeService extends BaseService {
    ...
    constructor(httpClient: HttpClient, _fuseAlertService: FuseAlertService) {
        super(httpClient, _fuseAlertService, 'staff', 'transactionFee/accountManagementFee');
    }
     ...
     * @param payload
     */
    searchAccountManagementFee(payload: BaseRequest = new BaseRequest()):
     ...
     * @param payload
     */
    searchAccountManagementFeeReq(payload: BaseRequest = new BaseRequest()):
        Observable<BaseResponse> {
        return this.searchDataLazyLoad('searchAccountManagementFeeReq', payload);
    }
    /**
     * getDetail
     *
