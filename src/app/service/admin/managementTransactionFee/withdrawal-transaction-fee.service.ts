...
export class WithdrawalTransactionFeeService extends BaseService {
    ...
    constructor(httpClient: HttpClient, _fuseAlertService: FuseAlertService) {
        super(httpClient, _fuseAlertService, 'staff', 'transactionFee/withdrawalTransactionFee');
    }
     ...
     * @param payload
     */
    searchWithdrawalTransactionFee(payload: BaseRequest = new BaseRequest()):
     ...
     * @param payload
     */
    searchWithdrawalTransactionFeeReq(payload: BaseRequest = new BaseRequest()):
        Observable<BaseResponse> {
        return this.searchDataLazyLoad('searchWithdrawalTransactionFeeReq', payload);
    }
