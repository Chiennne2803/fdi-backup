...
export class ManagementWithdrawHOService extends BaseService {
     ...
     * @param payload
     */
    initWithdrawReq(payload: FsTransWithdrawCashDTO = new FsTransWithdrawCashDTO()):
        Observable<BaseResponse> {
        return this.doPost('initWithdrawReq', payload);
    }
     ...
     * @param payload
     */
    doSignWithdrawReq(payload: FsTransWithdrawCashDTO = new FsTransWithdrawCashDTO()):
        Observable<BaseResponse> {
        return this.doPost('doSignWithdrawReq', payload);
    }
