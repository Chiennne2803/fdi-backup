...
export class ReportTransferTransactionService extends BaseService {
    constructor(httpClient: HttpClient, _fuseAlertService: FuseAlertService) {
        super(httpClient, _fuseAlertService, 'staff', 'report-transfer-transaction');
    }
    ...
    getReportDetail(payload: any):
        Observable<BaseResponse> {
        return this.doPost('getReportDetail', payload)
    }
