...
const defaultCustomColors = require("./configs/theme.config.ts").default;
...
const themes = {
    ...
    'default': {
        primary  : {
            ...colors.indigo,
            DEFAULT: defaultCustomColors.blue['1']
        },
        'primary-blue': {
            ...defaultCustomColors.blue,
            DEFAULT: defaultCustomColors.blue['1']
        },
        'primary-grayLight': {
            ...defaultCustomColors.grayLight,
            DEFAULT: defaultCustomColors.grayLight['1']
        },
        'primary-grayDark': {
            ...defaultCustomColors.grayDark,
            DEFAULT: defaultCustomColors.grayDark['1']
        },
        'primary-grayNeutral': {
            ...defaultCustomColors.grayNeutral,
            DEFAULT: defaultCustomColors.grayNeutral['1']
        },
        'primary-orange': {
            ...defaultCustomColors.orange,
            DEFAULT: defaultCustomColors.orange['1']
        },
        link: {
            DEFAULT: defaultCustomColors.link
        },
        accent   : {
            ...colors.slate,
